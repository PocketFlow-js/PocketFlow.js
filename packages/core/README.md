...
The [`@pocketflow/viz`](https://github.com/PocketFlow-js/PocketFlow.js/tree/main/packages/viz) package renders an interactive graph of your flow:
...
See the [examples](https://github.com/PocketFlow-js/PocketFlow.js/tree/main/packages/examples) directory for complete, runnable examples.
...
[MIT](https://github.com/PocketFlow-js/PocketFlow.js/blob/main/LICENSE)
